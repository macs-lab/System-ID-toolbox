function varargout=rls(y,u,na,nb,d,Fin,lam1,lam0)
% RLS   is used to identify a discrete time model of a plant operating in
% open-loop based on the recursive least squares method.
%
...
%
% See also FOLOE, AFOLOE, XOLOE, OLOE and RELS.
%
