function varargout = oloe(y,u,na,nb,d,Fin,lam1,lam0)
% OLOE  is used to identify a discrete time model of a plant operating in
% open-loop based on the output error method.
%
...
%
% See also FOLOE, AFOLOE, XOLOE, RLS and RELS.
%
